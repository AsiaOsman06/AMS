    ...
    <div className="master-layout">
      <div className="quote-container">
        <div className="quote-box">
          <p className="quote">
            “At my lowest point, I was blessed to have found Maple Grove
            Apartments for my family. The best home at the best prices for
            people like us!”
          </p>
        ...
        <div className="quote-box">
          <p className="quote">
            “I guess good landlords do exist! I’d recommend Maple Grove
        ...
        <div className="quote-box">
          <p className="quote">
            “My friends were SOOO jealous to hear I got a room at MG
            Apartments!”
          </p>
      ...
      <div className="welcome-container">
        <div className="welcome-card">
          <p className="welcome-message">
            ...
            Feel free to browse our expansive list of available rooms, or
      ...
      <div className="quote-container">
        <div className="quote-box">
          <p className="quote">
            “Prompt responses, great customer service, and a real dedication to
            their tenants. Honestly wish I didn’t have to leave.”
          </p>
          <p className="customer">- Satisfied customer #4</p>
        </div>
        <div className="quote-box">
          <p className="quote">
            “Very happy with my choice of apartment. Always felt like home, with
        ...
        <div className="quote-box">
          <p className="quote">
            “Always felt like I was taken care of. Every concern was promptly
            responded to, and always followed up with.”
          </p>
